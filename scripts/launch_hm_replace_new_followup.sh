#!/usr/bin/env bash
# Optional one-off launcher. Prefer the main stability sweep manifest
# (stale_incumbent_action includes replace_new) under capo_fast_seed0_priority.
set -uo pipefail
...
exec /home/ext_csh/miniconda3/envs/capo_jax/bin/python scripts/run_capo_jax.py \
  --config results_jax_sweeps/capo_stability_seed0_fast/fast_hm_s0_lt0_p50k_m1e3_replace_new/resolved_config.yaml
